...
const NilefySelect = observer(function NilefySelect() {
  const { id, onPropChange } = useContext(WidgetContext);

  const widget = editorStore.currentPage.getWidgetById(id);
  const props = widget.finalValues as NilefySelectProps;
...
export const NilefySelectWidget: Widget<NilefySelectProps> = {
  component: NilefySelect,
  config,
  initialProps,
  inspectorConfig,
