import { NilefyChartProps } from './interface';
...
export function calculateAggregation(
  data: NilefyChartProps['dataSource'],
  xAxisValue: NilefyChartProps['xAxisValue'],
  yAxisValue: NilefyChartProps['datasets'][0]['yValue'],
  method: NilefyChartProps['datasets'][0]['aggMethod'],
): number[] {
  switch (method) {
    case 'none': {
