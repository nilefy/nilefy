...
import { NilefyTextEditorProps } from '.';
...
export const NilefyTextEditor = observer(() => {
  const { onPropChange, id } = useContext(WidgetContext);
  const props = editorStore.currentPage.getWidgetById(id)
    .finalValues as NilefyTextEditorProps;
  const { label } = props;
...
NilefyTextEditor.displayName = 'NilefyTextEditor';

export default NilefyTextEditor;
