import { columnTypes } from '@/pages/Editor/Components/WebloomWidgets/Table/index';
import {
...
import {
  WebLoomTableColumn,
  webLoomTableColumn,
} from '@/pages/Editor/Components/WebloomWidgets/Table/index';
...
function ColumnDialog({
  ...
  // form config.
  const form = useForm<z.infer<typeof webLoomTableColumn>>({
    resolver: zodResolver(webLoomTableColumn),
    defaultValues: {
...
export default function SortableListWidget<
  T = any,
